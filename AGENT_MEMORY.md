...
| 2026-09-05 | Contacts gate feature branch | labels + static avatar + `#MyContacts` gate; e2e 21 green; local gates green | [HUMAN] open/merge PR (agent token cannot create PRs; main requires checks + linear history) |
| 2026-07-22 | v2.1.1 + v2.1.2 shipped | AUTOMERGE_TOKEN; ruleset CodeQL name; PR #5 auto path | Re-pin npm overrides for High Dependabot; fix automerge `GH_REPO` |
## Template Provenance
