...
- Playwright e2e tests for the Language Comparison page (14 site tests total)

### Changed

- Service worker cache bumped to `matrix-cache-v7` (includes new page assets)
- `site/sitemap.xml` lists `word-connections.html`
